...
function getTime() {
  ...
  const months = ['Yanva','Fevral','Mart','Aprel','May','Iyun','Iyul','Avgust','Sentyabr','Oktyabr','NOyabr','Dekabr']
  ...
  return (`${hour}:${minute}, ${date}.${months}.${year}`)
}
...
function showTodos() {
  ...
  todos.forEach((item, i) => {
    listGroupTodo.innerHTML += `
      ...
      <span class="opacity-50 me-2">${i}</span>
